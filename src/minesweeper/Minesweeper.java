...
/**
 * This class creates a frame for the MineSweeper panel to attach to. This class
 * is responsible for setting up and running the Minesweeper game.
 * 
...
public class Minesweeper {
	...
	/** An intermediate difficulty select in Difficult. */
		...
		class MenuActionListener implements ActionListener {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				if (e.getSource() == menuExpert) {
					frame.remove(board);
					board = new MineSweeperPanel(EXPERT,
							EXPERT_MINES);
					clearBoard();
				}
